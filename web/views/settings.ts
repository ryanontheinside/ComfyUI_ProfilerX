...
export function showSettings(element: HTMLElement) {
    let selectedArchive: Archive | null = null;
    ...
    const loadBtn = element.querySelector('#loadBtn') as HTMLButtonElement;
    const deleteBtn = element.querySelector('#deleteBtn') as HTMLButtonElement;
    ...
    const archiveBtn = element.querySelector('#archiveBtn') as HTMLButtonElement;
    ...
    async function refreshArchives() {
        const tbody = element.querySelector('#archivesTable tbody') as HTMLTableSectionElement;
        try {
